"""
SeedTrade.eu
Lithuania 2021 Geographic-Transfer Conflict Diagnostics v0.2
...
def main():
    ...
    print()
    print("=" * 78)
    print("SeedTrade.eu Lithuania 2021 Conflict Diagnostics v0.2")
    print("=" * 78)
    ...
    output = {
        ...
        "scientific_note":
            (
                ...
                "cycle disagreement in LT_VALIDATION 2021. This v0.2 reader "
