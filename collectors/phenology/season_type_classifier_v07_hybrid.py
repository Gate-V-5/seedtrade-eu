...
def clms_zone1_classification(pixel, reference_year=2023):
...
def classify_pixel(raw, baseline):
    clms = clms_zone1_classification(raw, 2023)
...
def main():
    ...
    print()
    print("=" * 78)
    print("SeedTrade.eu Season Type Classifier v0.7 - Hybrid")
    ...
    result = {
        "dataset":
            "SeedTrade.eu Season Type Classifier v0.7 Hybrid",
    ...
    print("v0.7 remains experimental until multi-year / multi-region validation.")
    print()
    print("JSON saved to:")
    print(output_path)
