"""
SeedTrade.eu Copernicus Pixel Intelligence v0.9
PL_EAST five-sample CPCSY spatial-validation runner.
...
- CPCSY is independent validation evidence only.
...
def dated_path(sample_id, suffix):
    ...
    return core.OUTPUT_DIR / (
        f"PL_EAST_pixel_intelligence_v09_cpcsy_"
        f"{core.TEST_YEAR}_"
        f"{sample_id}_"
        f"2km_400ha_test_"
...
def main():
    ...
    print(
        "PL_EAST | 5 x 400 ha CPCSY spatial-validation test"
    )
    ...
    summary = {
        ...
        "sampling_note":
            (
                "Five geographically separated heuristic "
                "400 ha windows for spatial-stability testing. "
                "Not a probability sample and not suitable for "
                "regional acreage estimation."
            ),
