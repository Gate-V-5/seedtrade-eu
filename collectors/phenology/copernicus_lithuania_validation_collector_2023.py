...
LT_VALIDATION five-sample out-of-sample multi-year validation runner.
...
# Geographic transfer test: Lithuania agricultural belt.
# All sample longitudes stay within UTM zone 34 used by the frozen v0.8 core.
core.TEST_REGION = {
    "region_code": "LT_VALIDATION",
    "country": "Lithuania",
    "region": "Lithuania agricultural belt validation",
    "latitude": 55.35,
    "longitude": 23.55,
}

SAMPLES = [
    # Heuristic cropland-rich validation windows; not a probability sample.
    # Chosen inside EPSG:32634 / UTM zone 34 for compatibility with frozen core.
    {"sample_id": "S01", "latitude": 56.10, "longitude": 23.70},
    {"sample_id": "S02", "latitude": 55.85, "longitude": 23.85},
    {"sample_id": "S03", "latitude": 55.35, "longitude": 23.85},
    {"sample_id": "S04", "latitude": 55.05, "longitude": 23.20},
    {"sample_id": "S05", "latitude": 54.65, "longitude": 23.55},
]
...
def main():
    ...
    print(
        f"LT_VALIDATION | {VALIDATION_YEAR} | 5 x 400 ha out-of-sample validation"
    )
