...
def find_validation_sample_jsons():
    ...
    files = sorted(
        COPERNICUS_DIR.glob(
            f"*multiyear_validation_pixel_intelligence_{VALIDATION_YEAR}_S??_2km_400ha_test_*.json"
        ),
...
def save_result(
    ...
    result = {
        ...
        "validation_mode": "OUT_OF_SAMPLE_FROZEN_V04_RULES",
...
def main():
    ...
    print(f"PL_EAST | {VALIDATION_YEAR} | 5 x 400 ha out-of-sample classification")
    print("========================================================")
    ...
    regional_result = {
        ...
        "validation_mode":
            "OUT_OF_SAMPLE_FROZEN_V04_RULES",
